        ...
        <div class="card-body">
            ...
            <form action="{{ url('status-update') }}" method="POST">
                ...
                <div class="form-group row">
                    <label for="inputEmail3" class="col-3 col-form-label font-weight-bold">User can accept/reject the
                        quotation</label>
                    <div class="col-2">
                        <select class="form-control drug_name @error('status') is-invalid @enderror" name="status">
